...
- The previous wording confused some users. User feedback included that "inability to wake/stay awake" was synonymous with feeling sleepy. This was not the intent. By including a brief description and also using another term to describe confusion, our aim is to clear up this confusion. New confusion or the inability to wake up or stay awake are emergency warning signs for C19 that if present, are a reason to seek emergency care.
